...
//            Delegate lambda = new Delegate(delegate(int x) { return 4; });
        ...
        public class EmptyOverridingTypedEquality : IEmptyInterface, IEquatable<IEmptyInterface>
        {
            ...
            public const string CalledTypedEqualsOnThisTypeOtherTemplate =
                "Called Typed-Equals on {0}. Other is a EmptyOverridingTypedEquality with Id {1}. Returning true";

            public const string CalledTypedEqualsOnNotThisTypeOtherTemplate =
                "Called Typed-Equals on {0}. Other is type {1} (not a EmptyOverridingTypedEquality). Returning false";

            public const string CalledTypedEqualsOnNullOtherTemplate =
                "Called Typed-Equals on {0}. Other is null. Returning false.";
        ...
        public class EmptyOverridingEverythingItCan : EmptyOverridingTypedEquality
        {
            ...
            public const string CalledUntypedEqualsOnThisTypeOtherTemplate =
                "Called Object-Equals on {0}. Other is a EmptyOverridingTypedEquality with Id {1}. Returning true";

            public const string CalledUntypedEqualsOnNotThisTypeOtherTemplate =
                "Called Object-Equals on {0}. Other is type {1} (not an EmptyOverridingEverythingItCan). Returning false";

            public const string CalledUntypedEqualsOnNullOtherTemplate =
                "Called Object-Equals on {0}. Other is null. Returning false.";
        ...
        public void when_calling_through_a_class_that_both_implements_iequatable_and_overrides_equals()
        {
            ...
            staticallyInterface.Equals(other)
                               .Should()
        ...
        public class FurtherDerrivedCloneable : DerrivedCloneable, ICloneable<FurtherDerrivedCloneable>
        {
            ...
            {
                return
                    (this as ICloneable<FurtherDerrivedCloneable>).Clone<FurtherDerrivedCloneable>() as
                    TCloneDerrivative;
            }
    ...
    {
        public static void ExtensionMethod<TElement>(
            this TestingBasicCSharpKnowhow.IAmCovariant<TElement> thisClass,
